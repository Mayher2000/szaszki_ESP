...
short Q, O, K, R, k = 0x10; /* k=moving side, 0x10 - white, 0x08 - black */
...
//     0,  0,  0,  0,  0,  0,  0,  0,  16, 9,  4,  1,  0,  1,  4,  9,
//     41,  0,  0,  0,  0,  0,  0,  0,  18, 11, 6,  3,  2,  3,  6,  11,
//     0,  9,  9,  9,  9,  9,  9,  9,  22, 15, 10, 7,  6,  7,  10, 15,
...
serialBoard();
  ...
  K = I;
  N = 0;
  // moc silnika 0x3F = 63, chyba max
  T = 0x3F;       
  int r = D(-I, I, Q, O, 1, 3); /* Think & do*/
  if (!(r > -I + 1)){
    Serial.println("Lose*");
    gameOver();
  }
