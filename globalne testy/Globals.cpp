...
{                                                      /* e=score, z=prev.dest; J,Z=hashkeys; return score*/
    ...
    W(d++ < n || d < 3 ||                                            /*** min depth = 2   iterative deepening loop */
      z == 8 & K == I && (millis() - Ticks < tlim & d <= MaxDepth || /* root: deepen upto time   */
...
{   
    ...
    int boardSize = sizeof(b) / sizeof(char);
    int moveSize = sizeof(engineMove) / sizeof(char);
    std::vector<char> board(b, b + boardSize);
    std::vector<char> move(engineMove, engineMove + moveSize);
